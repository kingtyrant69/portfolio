  ...
  return (
    ...
    <div className="h-full w-full fixed top-0 left-0">
      <div className="flex justify-between items-center lg:m-10 lg:p-0 p-2">
        ...
        <a href="https://drive.google.com/file/d/18YF517RKYlpDpFH1-JRVqx8VyBYUnZXI/view?usp=sharing"><button className="btn-20"><span className="flex items-center gap-2"><p className="hidden lg:inline-block">My Resume </p><BsArrow90DegRight size={15}/></span></button></a>
      </div>
