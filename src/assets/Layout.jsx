  ...
  return (
    ...
    <div className="h-full w-full fixed top-0 left-0">
      <div className="flex justify-between items-center lg:m-10 m-2">
        ...
        <a href="https://drive.google.com/file/d/1K00uhQNZ5q3NZivMPOYg50-jwHFPTF7E/view?usp=drive_link"><button className="btn-20"><span className="flex items-center gap-2"><p className="hidden lg:inline-block">My Resume </p><BsArrow90DegRight size={15}/></span></button></a>
      </div>
