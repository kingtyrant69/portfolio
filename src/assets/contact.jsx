...
const Contact = () => {
  ...
  return (
    <div className="top-0 sticky">
      <div
        ref={sectionRef}
        className="flex justify-center lg:h-[110vh] bg-slate-50"
      > 
        <div
          className={` bg-black flex flex-col lg:gap-20 gap-10 lg:rounded-[80px] rounded-[50px] lg:p-16 lg:justify-normal justify-center p-10`}
          style={{
            width: window.innerWidth >= 640 ? width : '100%', // Apply dynamic width for larger screens only
            transition: window.innerWidth >= 640 ? 'width 0.1s ease' : 'none', // Apply transition only for larger screens
          }}
        >
          <p className="xl:text-[130px] lg:text-[100px] lg:py-0 pt-2 text-[3.9rem] text-white inline leading-none font-[500] tracking-[-.01em]">Get In Touch With Me!</p>
          ...
          <div className=" lg:w-1/3 flex flex-col gap-2 lg:text-xl ">
