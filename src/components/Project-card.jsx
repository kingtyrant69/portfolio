    ...
    <div>
      <div className={`${color} h-screen w-full lg:rounded-t-[80px] rounded-t-[50px] p-24`}>
        <div className="flex justify-center">
          <div className="flex flex-col lg:flex-row lg:gap-20 gap-5 w-2/3">
        ...
        <div className="flex justify-center items-center">
          ...
          <img src={image_url} className="w-[100%] lg:w-[50%] h-fit hover:scale-105 transition lg:mt-20 mt-10"/>
        </div>
      </div>
    </div>
  );
